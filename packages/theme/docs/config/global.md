...
下面开始详细介绍 [Theme.BlogConfig](https://github.com/Desain7/personal-blog/blob/255c4b1e6a85a529be3a72c88e365077e067ecba/packages/theme/src/composables/config/index.ts#L69-L137)
...
如果需要自定义更多的内容可以使用独立的插件 [vitepress-plugin-pagefind](https://github.com/Desain7/personal-blog/blob/master/packages/vitepress-plugin-pagefind/README-zh.md)
