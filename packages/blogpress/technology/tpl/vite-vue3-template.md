...
## 体验模板
>[模板仓库地址](https://github.com/Desain7/vite-vue3-template)
...
```sh
# 方法一
npx degit Desain7/vite-vue3-template#main my-project
...
```sh
# 方法二
git clone https://github.com/Desain7/vite-vue3-template.git
