...
[示例代码1](https://github.com/Desain7/tools/blob/main/packages/cli/efst/__test__/download/1.ts)
...
[示例代码2](https://github.com/Desain7/tools/blob/main/packages/cli/efst/__test__/download/2.ts)
...
[示例代码3](https://github.com/Desain7/tools/blob/main/packages/cli/efst/__test__/download/3.ts)
...
```
[示例代码4](https://github.com/Desain7/tools/blob/main/packages/cli/efst/__test__/download/4.ts)
...
[示例代码5](https://github.com/Desain7/tools/blob/main/packages/cli/efst/__test__/download/5.ts)
...
[示例代码6](https://github.com/Desain7/tools/blob/main/packages/cli/efst/__test__/download/6.ts)
...
[示例代码7](https://github.com/Desain7/tools/blob/main/packages/cli/efst/__test__/download/7.ts)
...
[示例代码8](https://github.com/Desain7/tools/blob/main/packages/cli/efst/__test__/download/8.ts)
...
setCLIConfig('github.name', 'Desain7')
setCLIConfig('github.info.url', 'https://github.com/Desain7')
```
...
CLI完整源码见[GitHub](https://github.com/Desain7/tools/tree/main/packages/cli/efst)
