...
**百闻不如[一见](https://github.com/Desain7/eslint-plugin-todo-ddl)**,先带大家看看[插件](https://github.com/Desain7/eslint-plugin-todo-ddl)效果
...
想亲自尝试一下的同学戳[这里](https://github.com/Desain7/eslint-plugin-todo-ddl)---顺手Star
...
// 未设置DDL或者DDL不合法情况
if (!date) {
    errMsg = '没有设置有效的Deadline,设置方法(https://github.com/Desain7/eslint-plugin-todo-ddl)'
} else {
