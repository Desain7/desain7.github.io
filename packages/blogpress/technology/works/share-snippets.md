...
先给各位哥哥姐姐奉上插件相关链接
* [仓库地址](https://github.com/Desain7/ShareSnippet)
* [插件:Share Snippets](https://marketplace.visualstudio.com/items?itemName=Desain.snippet)
...
1. 安装上述插件
2. 按照[文档](https://github.com/Desain7/ShareSnippet/blob/master/README.md#%E5%8A%9F%E8%83%BD)简单编写一个以 **.snippets.json**结尾的snippet文件在项目中的任意位置(包括node_modules)
...
这个插件就问世了: [Share Snippets](https://marketplace.visualstudio.com/items?itemName=Desain.snippet)
